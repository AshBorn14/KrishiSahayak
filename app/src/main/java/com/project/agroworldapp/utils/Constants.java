...
public class Constants {
    ...
    public static final String ABOUT_US_PAGE = "https://fringe-spell-ad3.notion.site/KRISHI-SAHAYAK-0dbe39f98e0945678c9c732331f9ae50";
    public static final String PRIVACY_POLICY = "https://fringe-spell-ad3.notion.site/Privacy-Policy-4b8edcfd5f6e405f9128add331fbfb38?pvs=4";
    ...
    public static void printLog(String message) {
        Log.d("KrishiSahayakUser", message);
    }

    public static void identifyUser(FirebaseUser user, Context context) {
        if (user.getEmail() != null) {
            if (user.getEmail().equals("shiv@gmail.com") ) {
                //Manufacture user
            ...
            } else if (user.getEmail().equals("vishal@gmail.com") ) {
                //transport user
...
//            GoogleSignIn.getClient(context, gso).revokeAccess();
    ...
    public static void adminEmailContact(Context context) {
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"shivforcollege@gmail.com"});
